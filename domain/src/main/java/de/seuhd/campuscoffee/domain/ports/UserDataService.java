...
public interface UserDataService {
     ...
     */
    @NonNull User getById(@NonNull Long id) throws NotFoundException;
     ...
     */
    @NonNull User getByLoginName(@NonNull String loginName) throws NotFoundException;
     ...
     */
    @NonNull User upsert(@NonNull User user) throws NotFoundException;
     ...
     * @throws NotFoundException if no user exists with the given ID
     */
    void delete(@NonNull Long id) throws NotFoundException;
}
